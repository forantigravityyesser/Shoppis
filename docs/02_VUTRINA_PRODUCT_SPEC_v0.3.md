...
|---|---|---|
| Главная | `/seller/dashboard` | операционная панель: продажи, заказы, склад, требует внимания |
| Склад | `/seller/inventory` | остатки (`в наличии` / `в ожидании`), перемещения |
...
- **Settings → Магазин** — баннер, название, описание, валюта, язык, контакт поддержки.
